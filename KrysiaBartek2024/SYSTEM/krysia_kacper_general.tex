...
\addcontentsline{toc}{chapter}{1-level opening overcall}

\section*{\colorbox{blue!30}{1\clubs\ opening overcall}}
\addcontentsline{toc}{section}{1\clubs\ opening overcall}
...
\addcontentsline{toc}{section}{1\diams\ opening overcall}
...
\addcontentsline{toc}{section}{1\hearts\ opening overcall}
...
\addcontentsline{toc}{section}{1\spades\ opening overcall}
